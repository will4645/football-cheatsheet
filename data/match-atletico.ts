  ...
  homeTeam: {
    ...
    players: {
      ...
      cards: [
        ...
        { name: 'Robin Le Normand',  appearances: 22, yellowCards: 3, redCards: 0, cardsPerGame: 0.14, last5Cards: [false,true,false,false,true] },
        { name: 'Antoine Griezmann', appearances: 18, yellowCards: 2, redCards: 0, cardsPerGame: 0.11, last5Cards: [false,false,false,true,false]},
  ...
  awayTeam: {
    ...
    players: {
      ...
      cards: [
        ...
        { name: 'Pedri',           appearances: 28, yellowCards: 3, redCards: 0, cardsPerGame: 0.11, last5Cards: [false,false,true,false,false] },
        { name: 'Pau Cubarsí',     appearances: 30, yellowCards: 3, redCards: 0, cardsPerGame: 0.10, last5Cards: [false,true,false,false,false] },
        { name: 'Lamine Yamal',    appearances: 33, yellowCards: 2, redCards: 0, cardsPerGame: 0.06, last5Cards: [false,false,false,true,false] },
        { name: 'Ferran Torres',   appearances: 22, yellowCards: 1, redCards: 0, cardsPerGame: 0.05, last5Cards: [false,false,false,false,true] },
