...
export const atleticoMatchData: {
  ...
  homeTeam: {
    ...
    stats: {
      ...
      tacklesFor: 20.18, tacklesAgainst: 18.64, over345Tackles: 65,
    ...
    players: {
      ...
      shooting: [
        ...
        { name: 'Rodrigo De Paul',   mins: 71, sotPerGame: 0.27, last5SoT: [false,true,false,false,false], shotsPerGame: 0.82, last5Shots: [false,true,true,false,false],   form: 'ok'   },
        { name: 'Koke',              mins: 69, sotPerGame: 0.21, last5SoT: [false,false,false,true,false],  shotsPerGame: 0.68, last5Shots: [true,false,false,true,false],   form: 'poor' },
        { name: 'Marcos Ruggeri',    mins: 69, sotPerGame: 0.14, last5SoT: [false,false,true,false,false],  shotsPerGame: 0.42, last5Shots: [false,false,true,false,false],  form: 'ok'   },
        { name: 'Robin Le Normand',  mins: 61, sotPerGame: 0.09, last5SoT: [false,false,false,false,true],  shotsPerGame: 0.31, last5Shots: [false,true,false,false,false],  form: 'ok'   },
        { name: 'Reinildo Mandava',  mins: 65, sotPerGame: 0.06, last5SoT: [false,false,false,false,false], shotsPerGame: 0.21, last5Shots: [false,false,false,true,false],  form: 'ok'   },
      ],
      goalscoring: [
        ...
        { name: 'Rodrigo De Paul',   mins: 71, goals: 2,  assists: 2, gaPerGame: 0.11, last5Goals: [false,true,false,false,false],  last5Assists: [false,false,true,false,false],  form: 'ok'   },
        { name: 'Koke',              mins: 69, goals: 2,  assists: 3, gaPerGame: 0.09, last5Goals: [false,false,false,true,false],  last5Assists: [false,false,false,false,true],  form: 'poor' },
        { name: 'Marcos Ruggeri',    mins: 69, goals: 1,  assists: 2, gaPerGame: 0.09, last5Goals: [false,false,false,false,false], last5Assists: [false,true,false,false,false],  form: 'ok'   },
        { name: 'Reinildo Mandava',  mins: 65, goals: 1,  assists: 0, gaPerGame: 0.04, last5Goals: [false,false,false,false,false], last5Assists: [false,false,false,false,false], form: 'ok'   },
        { name: 'Clément Lenglet',   mins: 78, goals: 0,  assists: 1, gaPerGame: 0.03, last5Goals: [false,false,false,false,false], last5Assists: [false,false,false,false,false], form: 'ok'   },
      ],
      cards: [
        { name: 'Marcos Ruggeri',    appearances: 25, yellowCards: 6, redCards: 0, cardsPerGame: 0.24, last5Cards: [false,'yellow','yellow',false,'yellow']  },
        { name: 'Clément Lenglet',   appearances: 29, yellowCards: 6, redCards: 1, cardsPerGame: 0.21, last5Cards: ['yellow',false,'red',false,'yellow']     },
        { name: 'Marcos Llorente',   appearances: 33, yellowCards: 7, redCards: 0, cardsPerGame: 0.21, last5Cards: [false,'yellow',false,'yellow',false]     },
        { name: 'Rodrigo De Paul',   appearances: 28, yellowCards: 4, redCards: 0, cardsPerGame: 0.18, last5Cards: [false,false,'yellow',false,'yellow']     },
        { name: 'Giovanni Simeone',  appearances: 20, yellowCards: 3, redCards: 0, cardsPerGame: 0.15, last5Cards: [false,false,'yellow',false,false]        },
        { name: 'Robin Le Normand',  appearances: 22, yellowCards: 3, redCards: 0, cardsPerGame: 0.14, last5Cards: [false,'yellow',false,false,'yellow']     },
        { name: 'Antoine Griezmann', appearances: 18, yellowCards: 2, redCards: 0, cardsPerGame: 0.11, last5Cards: [false,false,false,'yellow',false]        },
        { name: 'Julián Álvarez',    appearances: 29, yellowCards: 2, redCards: 0, cardsPerGame: 0.07, last5Cards: [false,false,false,false,false]           },
        { name: 'Koke',              appearances: 30, yellowCards: 2, redCards: 0, cardsPerGame: 0.07, last5Cards: [false,false,false,false,false]           },
        { name: 'Reinildo Mandava',  appearances: 28, yellowCards: 1, redCards: 0, cardsPerGame: 0.04, last5Cards: [false,false,false,false,false]           },
      ],
      gk: [
  ...
  awayTeam: {
    ...
    stats: {
      ...
      tacklesFor: 16.42, tacklesAgainst: 22.85, over345Tackles: 70,
    ...
    players: {
      defensive: [
        ...
        { name: 'Pedri',           mins: 72, foulsPerGame: 0.88, tacklesPerGame: 1.22, last5Fouls: [true,false,true,false,true],   yellowCards: 3, potentialOpponent: 'De Paul',         form: 'good' },
        { name: 'Jules Koundé',    mins: 77, foulsPerGame: 0.72, tacklesPerGame: 1.51, last5Fouls: [true,false,false,false,true],  yellowCards: 2, potentialOpponent: 'Griezmann',       form: 'ok'   },
        { name: 'Pau Cubarsí',     mins: 82, foulsPerGame: 0.61, tacklesPerGame: 1.14, last5Fouls: [false,false,true,false,false], yellowCards: 3, potentialOpponent: 'Álvarez',         form: 'good' },
        { name: 'Lamine Yamal',    mins: 83, foulsPerGame: 0.38, tacklesPerGame: 0.52, last5Fouls: [false,true,false,false,false], yellowCards: 1, potentialOpponent: 'Reinildo',        form: 'good' },
        { name: 'Ferran Torres',   mins: 53, foulsPerGame: 0.31, tacklesPerGame: 0.41, last5Fouls: [false,false,false,true,false], yellowCards: 1, potentialOpponent: 'Le Normand',      form: 'good' },
      ],
      offensive: [
        ...
        { name: 'Fermín López',    mins: 62, foulsWonPerGame: 0.88, last5FoulsWon: [true,false,true,false,true],  potentialOpponent: 'De Paul',         form: 'good' },
        { name: 'Ferran Torres',   mins: 53, foulsWonPerGame: 0.75, last5FoulsWon: [true,true,false,false,true],  potentialOpponent: 'Le Normand',      form: 'good' },
        { name: 'João Cancelo',    mins: 66, foulsWonPerGame: 0.64, last5FoulsWon: [false,true,false,true,false], potentialOpponent: 'Griezmann',       form: 'poor' },
        { name: 'Eric García',     mins: 78, foulsWonPerGame: 0.35, last5FoulsWon: [false,false,false,true,false],potentialOpponent: 'Álvarez',         form: 'ok'   },
        { name: 'Pau Cubarsí',     mins: 82, foulsWonPerGame: 0.24, last5FoulsWon: [false,false,true,false,false],potentialOpponent: 'Álvarez',         form: 'good' },
      ],
      shooting: [
        ...
        { name: 'Pedri',           mins: 72, sotPerGame: 0.38, last5SoT: [false,true,false,false,true],  shotsPerGame: 1.22, last5Shots: [true,false,true,false,true],    form: 'good' },
        { name: 'Gavi',            mins: 32, sotPerGame: 0.25, last5SoT: [false,false,true,false,false],  shotsPerGame: 0.77, last5Shots: [true,false,false,true,false],   form: 'ok'   },
        { name: 'Jules Koundé',    mins: 77, sotPerGame: 0.19, last5SoT: [false,false,false,true,false],  shotsPerGame: 0.56, last5Shots: [false,false,true,false,false],  form: 'ok'   },
        { name: 'Pau Cubarsí',     mins: 82, sotPerGame: 0.08, last5SoT: [false,false,false,false,true],  shotsPerGame: 0.21, last5Shots: [false,false,true,false,false],  form: 'good' },
        { name: 'Eric García',     mins: 78, sotPerGame: 0.06, last5SoT: [false,false,false,false,false], shotsPerGame: 0.15, last5Shots: [false,false,false,false,true],  form: 'ok'   },
      ],
      goalscoring: [
        ...
        { name: 'Pedri',           mins: 72, goals: 6,  assists: 7,  gaPerGame: 0.18, last5Goals: [false,true,false,false,false], last5Assists: [true,false,true,false,false],   form: 'good' },
        { name: 'João Cancelo',    mins: 66, goals: 3,  assists: 5,  gaPerGame: 0.12, last5Goals: [false,false,false,true,false], last5Assists: [false,true,false,false,false],  form: 'poor' },
        { name: 'Gavi',            mins: 32, goals: 1,  assists: 2,  gaPerGame: 0.09, last5Goals: [false,false,false,false,false],last5Assists: [false,false,false,true,false],  form: 'ok'   },
        { name: 'Pau Cubarsí',     mins: 82, goals: 0,  assists: 2,  gaPerGame: 0.05, last5Goals: [false,false,false,false,false],last5Assists: [false,false,false,false,true],  form: 'good' },
        { name: 'Eric García',     mins: 78, goals: 1,  assists: 0,  gaPerGame: 0.04, last5Goals: [false,false,false,false,false],last5Assists: [false,false,false,false,false], form: 'ok'   },
      ],
      cards: [
        { name: 'Fermín López',    appearances: 28, yellowCards: 5, redCards: 0, cardsPerGame: 0.18, last5Cards: ['yellow',false,false,'yellow',false]  },
        { name: 'Eric García',     appearances: 27, yellowCards: 4, redCards: 1, cardsPerGame: 0.15, last5Cards: [false,'yellow',false,false,'red']     },
        { name: 'Gavi',            appearances: 14, yellowCards: 2, redCards: 0, cardsPerGame: 0.14, last5Cards: [false,'yellow',false,false,false]     },
        { name: 'Jules Koundé',    appearances: 31, yellowCards: 4, redCards: 0, cardsPerGame: 0.13, last5Cards: [false,false,'yellow',false,false]     },
        { name: 'João Cancelo',    appearances: 27, yellowCards: 3, redCards: 0, cardsPerGame: 0.11, last5Cards: [false,false,false,'yellow',false]     },
        { name: 'Pedri',           appearances: 28, yellowCards: 3, redCards: 0, cardsPerGame: 0.11, last5Cards: [false,false,'yellow',false,false]     },
        { name: 'Pau Cubarsí',     appearances: 30, yellowCards: 3, redCards: 0, cardsPerGame: 0.10, last5Cards: [false,'yellow',false,false,false]     },
        { name: 'Lamine Yamal',    appearances: 33, yellowCards: 2, redCards: 0, cardsPerGame: 0.06, last5Cards: [false,false,false,'yellow',false]     },
        { name: 'Ferran Torres',   appearances: 22, yellowCards: 1, redCards: 0, cardsPerGame: 0.05, last5Cards: [false,false,false,false,'yellow']     },
        { name: 'Dani Olmo',       appearances: 26, yellowCards: 1, redCards: 0, cardsPerGame: 0.04, last5Cards: [false,false,false,false,false]        },
      ],
      gk: [
