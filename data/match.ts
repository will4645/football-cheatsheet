...
export interface TeamData {
  ...
  stats: {
    ...
    throwInsFor: number; throwInsAgainst: number; over295ThrowIns: number;
  };
  players: {
...
export const matchData: {
  ...
  homeTeam: {
    ...
    stats: {
      ...
      throwInsFor: 17.45, throwInsAgainst: 14.82, over295ThrowIns: 70,
    },
    players: {
      defensive: [
      ...
      shooting: [
        ...
        { name: 'Rodrigo De Paul',   mins: 71, sotPerGame: 0.25, last5SoT: [false,true,false,false,false], shotsPerGame: 0.72, last5Shots: [true,false,false,true,false],         form: 'ok'   },
        { name: 'Koke',              mins: 69, sotPerGame: 0.19, last5SoT: [false,false,false,true,false],  shotsPerGame: 0.58, last5Shots: [false,false,true,false,false],        form: 'poor' },
        { name: 'Robin Le Normand',  mins: 61, sotPerGame: 0.12, last5SoT: [false,false,false,false,true],  shotsPerGame: 0.35, last5Shots: [false,true,false,false,false],        form: 'ok'   },
        { name: 'Marcos Ruggeri',    mins: 69, sotPerGame: 0.08, last5SoT: [false,false,false,false,false], shotsPerGame: 0.22, last5Shots: [false,false,false,true,false],        form: 'ok'   },
        { name: 'Reinildo Mandava',  mins: 65, sotPerGame: 0.05, last5SoT: [false,false,false,false,false], shotsPerGame: 0.15, last5Shots: [false,false,false,false,true],        form: 'ok'   },
      ],
      goalscoring: [
        ...
        { name: 'Ademola Lookman',   mins: 48, goals: 3,  assists: 2,  gaPerGame: 0.11, last5Goals: [true,false,false,false,true],  last5Assists: [false,false,true,false,false],  form: 'ok'   },
        { name: 'Rodrigo De Paul',   mins: 71, goals: 2,  assists: 4,  gaPerGame: 0.10, last5Goals: [false,false,false,true,false], last5Assists: [false,true,false,false,true],   form: 'ok'   },
        { name: 'Koke',              mins: 69, goals: 2,  assists: 3,  gaPerGame: 0.09, last5Goals: [false,false,false,false,false],last5Assists: [false,false,true,false,false],   form: 'poor' },
        { name: 'Marcos Ruggeri',    mins: 69, goals: 1,  assists: 0,  gaPerGame: 0.04, last5Goals: [false,false,false,false,false],last5Assists: [false,false,false,false,false],  form: 'ok'   },
        { name: 'Reinildo Mandava',  mins: 65, goals: 0,  assists: 1,  gaPerGame: 0.02, last5Goals: [false,false,false,false,false],last5Assists: [false,false,false,false,false],  form: 'ok'   },
      ],
      cards: [
        ...
        { name: 'Robin Le Normand',  appearances: 26, yellowCards: 3, redCards: 0, cardsPerGame: 0.12, last5Cards: [false,true,false,false,false]  },
        { name: 'Antoine Griezmann', appearances: 22, yellowCards: 2, redCards: 0, cardsPerGame: 0.09, last5Cards: [false,false,false,true,false]  },
        { name: 'Koke',              appearances: 24, yellowCards: 2, redCards: 0, cardsPerGame: 0.08, last5Cards: [false,false,true,false,false]   },
        { name: 'Julián Álvarez',    appearances: 29, yellowCards: 2, redCards: 0, cardsPerGame: 0.07, last5Cards: [false,false,false,true,false]  },
        { name: 'Reinildo Mandava',  appearances: 23, yellowCards: 1, redCards: 0, cardsPerGame: 0.04, last5Cards: [false,false,false,false,false]  },
      ],
      gk: [
  ...
  awayTeam: {
    ...
    stats: {
      ...
      throwInsFor: 13.24, throwInsAgainst: 18.56, over295ThrowIns: 70,
    },
    players: {
      defensive: [
        ...
        { name: 'Pedri',           mins: 72, foulsPerGame: 0.88, tacklesPerGame: 1.24, last5Fouls: [true,false,true,false,false],  yellowCards: 3, potentialOpponent: 'De Paul',         form: 'good' },
        { name: 'Lamine Yamal',    mins: 83, foulsPerGame: 0.72, tacklesPerGame: 0.52, last5Fouls: [false,true,false,false,true],  yellowCards: 1, potentialOpponent: 'Ruggeri',         form: 'good' },
        { name: 'Ferran Torres',   mins: 53, foulsPerGame: 0.58, tacklesPerGame: 0.44, last5Fouls: [false,false,false,true,false], yellowCards: 2, potentialOpponent: 'Lenglet',         form: 'good' },
        { name: 'Jules Koundé',    mins: 77, foulsPerGame: 0.45, tacklesPerGame: 1.65, last5Fouls: [false,false,true,false,false], yellowCards: 2, potentialOpponent: 'Lookman',         form: 'ok'   },
        { name: 'Alejandro Balde', mins: 74, foulsPerGame: 0.38, tacklesPerGame: 1.12, last5Fouls: [false,false,false,false,true], yellowCards: 1, potentialOpponent: 'Griezmann',       form: 'ok'   },
      ],
      offensive: [
        ...
        { name: 'Ferran Torres',   mins: 53, foulsWonPerGame: 0.88, last5FoulsWon: [true,false,true,false,true], potentialOpponent: 'Lenglet',         form: 'good' },
        { name: 'Fermín López',    mins: 62, foulsWonPerGame: 0.75, last5FoulsWon: [false,true,false,true,false],potentialOpponent: 'Simeone',         form: 'good' },
        { name: 'Alejandro Balde', mins: 74, foulsWonPerGame: 0.52, last5FoulsWon: [false,false,true,false,true],potentialOpponent: 'Griezmann',       form: 'ok'   },
        { name: 'João Cancelo',    mins: 66, foulsWonPerGame: 0.38, last5FoulsWon: [false,true,false,false,false],potentialOpponent: 'Griezmann',      form: 'poor' },
        { name: 'Eric García',     mins: 78, foulsWonPerGame: 0.25, last5FoulsWon: [false,false,false,true,false],potentialOpponent: 'Álvarez',        form: 'ok'   },
      ],
      shooting: [
        ...
        { name: 'Pedri',           mins: 72, sotPerGame: 0.38, last5SoT: [false,false,true,false,true], shotsPerGame: 1.24, last5Shots: [true,false,false,true,false],        form: 'good' },
        { name: 'Gavi',            mins: 32, sotPerGame: 0.32, last5SoT: [false,true,false,false,false],shotsPerGame: 0.95, last5Shots: [false,true,false,false,true],        form: 'ok'   },
        { name: 'Jules Koundé',    mins: 77, sotPerGame: 0.22, last5SoT: [false,false,false,true,false],shotsPerGame: 0.72, last5Shots: [false,false,true,false,false],       form: 'ok'   },
        { name: 'Alejandro Balde', mins: 74, sotPerGame: 0.15, last5SoT: [false,false,false,false,true],shotsPerGame: 0.48, last5Shots: [false,true,false,false,false],       form: 'ok'   },
        { name: 'Eric García',     mins: 78, sotPerGame: 0.08, last5SoT: [false,false,false,false,false],shotsPerGame: 0.25, last5Shots: [false,false,false,true,false],      form: 'ok'   },
      ],
      goalscoring: [
        ...
        { name: 'Pedri',           mins: 72, goals: 5,  assists: 8,  gaPerGame: 0.19, last5Goals: [false,true,false,false,true], last5Assists: [true,false,false,true,false],  form: 'good' },
        { name: 'Gavi',            mins: 32, goals: 2,  assists: 3,  gaPerGame: 0.14, last5Goals: [false,false,true,false,false],last5Assists: [false,true,false,false,false], form: 'ok'   },
        { name: 'João Cancelo',    mins: 66, goals: 2,  assists: 3,  gaPerGame: 0.12, last5Goals: [false,false,false,true,false],last5Assists: [false,false,true,false,false], form: 'poor' },
        { name: 'Alejandro Balde', mins: 74, goals: 1,  assists: 2,  gaPerGame: 0.08, last5Goals: [false,false,false,false,false],last5Assists: [false,false,false,true,false],form: 'ok'   },
        { name: 'Eric García',     mins: 78, goals: 1,  assists: 0,  gaPerGame: 0.05, last5Goals: [false,false,false,false,false],last5Assists: [false,false,false,false,false],form: 'ok'  },
      ],
      cards: [
        ...
        { name: 'Pedri',           appearances: 30, yellowCards: 3, redCards: 0, cardsPerGame: 0.10, last5Cards: [false,true,false,false,false]  },
        { name: 'Dani Olmo',       appearances: 26, yellowCards: 2, redCards: 0, cardsPerGame: 0.08, last5Cards: [false,false,false,false,true]  },
        { name: 'Ferran Torres',   appearances: 25, yellowCards: 2, redCards: 0, cardsPerGame: 0.08, last5Cards: [false,false,true,false,false]  },
        { name: 'Lamine Yamal',    appearances: 31, yellowCards: 2, redCards: 0, cardsPerGame: 0.06, last5Cards: [false,false,false,false,false] },
        { name: 'Alejandro Balde', appearances: 28, yellowCards: 1, redCards: 0, cardsPerGame: 0.04, last5Cards: [false,false,false,false,false] },
      ],
      gk: [
